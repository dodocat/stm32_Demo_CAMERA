...
//	 LCD_WR_REG(0x07, 0x0001); // 
        /*	 
         ...
         LCD_WR_REG(0x12, 0x0029); // Internal reference voltage= Vci;
        Delay(10); // Delay 50ms
	...
	*/  
        ...
        Delay(10); // Delay 50ms
         ...
         LCD_WR_REG(0x29, 0x000f); // Set VCM[5:0] for VCOMH
...
// ----------- Adjust the Gamma Curve ----------//
	/*     LCD_WR_REG(0x0030,0x0001);
	     LCD_WR_REG(0x0031,0x0606);
	     LCD_WR_REG(0x0032,0x0304);
	     LCD_WR_REG(0x0033,0x0202);
	     LCD_WR_REG(0x0034,0x0202);
	     LCD_WR_REG(0x0035,0x0103);
	     LCD_WR_REG(0x0036,0x1F0d);
	     LCD_WR_REG(0x0037,0x0404);
	     LCD_WR_REG(0x0038,0x0404);
	     LCD_WR_REG(0x0039,0x0404);
	     LCD_WR_REG(0x003c,0x0700);
	     LCD_WR_REG(0x003d,0x1a0f);
             */
