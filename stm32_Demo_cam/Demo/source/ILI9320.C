...
{   
  ...
  //    LCD_WR_REG(0x00e5,0x8000); 
     ...
     LCD_WR_REG(0x0003,0x1038);
         ...
         LCD_WR_REG(0x08, 0x0804); // set the back porch and front porch
...
//	 LCD_WR_REG(0x07, 0x0001); // 
         ...
         Delay(5); // Delay 50ms
         LCD_WR_REG(0x10, 0x15b0); // SAP, BT[3:0], AP, DSTB, SLP, STB
         ...
         LCD_WR_REG(0x29, 0x0020); // Set VCM[5:0] for VCOMH
     ...
     /*    Delay(10); // Dis-charge capacitor power voltage
         ...
         LCD_WR_REG(0x11, 0x0037); // DC1[2:0], DC0[2:0], VC[2:0]
         Delay(10); // Delay 50ms
        
         LCD_WR_REG(0x12, 0x0136); // Internal reference voltage= Vci;
        Delay(10); // Delay 50ms
         LCD_WR_REG(0x13, 0x1f00); // Set VDV[4:0] for VCOM amplitude
         LCD_WR_REG(0x29, 0x0032); // Set VCM[5:0] for VCOMH
...
// ----------- Adjust the Gamma Curve ----------//
	...
	LCD_WR_REG(0x003c,0x0501);
	 LCD_WR_REG(0x003d,0x0704); 
         
    LCD_WR_REG(0x0030, 0x0504);		
    LCD_WR_REG(0x0031, 0x0701);		
    LCD_WR_REG(0x0032, 0x0703);	
    LCD_WR_REG(0x0035, 0x0203);		
    LCD_WR_REG(0x0036, 0x0a10);		
    LCD_WR_REG(0x0037, 0x0707);		
    LCD_WR_REG(0x0038, 0x0706);		
    LCD_WR_REG(0x0039, 0x0707);
   LCD_WR_REG(0x003d,0x0910); */ 
